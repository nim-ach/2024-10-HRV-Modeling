...
The priors were selected based on physiological constraints and are detailed in @eq-priors.
...
The fitting process utilized four Markov Chain Monte Carlo (MCMC) chains, each consisting of 12,500 iterations with a burn-in period of 5,000 iterations, resulting in a total of 30,000 post-warmup samples.
...
![](figures/model-constituents.pdf)
...
![](figures/sobol-sensitivity.pdf)

[**Figure 3**]{#fig-sensitivity}. Sensitivity analysis results illustrating the impact of parameter variability on model predictions. Shaded areas represent 95%, 80%, and 60% CI estimated from Monte Carlo samples.
